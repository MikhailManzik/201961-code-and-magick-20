...
window.renderStatistics = function (ctx, players, times) {
  renderCloud(ctx, CLOUD_POINT_X + DISPLACE, CLOUD_POINT_Y + DISPLACE, CLOUD_COLOR_SHADOW);
  renderCloud(ctx, CLOUD_POINT_X, CLOUD_POINT_Y, CLOUD_COLOR_BG);
